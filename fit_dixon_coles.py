...
with open("reporte.txt", "w") as f:
    f.write(f"Predicción: {home} vs {away}\n\n")
    f.write("Probabilidades:\n")
    f.write(f"{home} gana: {home_win*100:.1f}%\n")
    f.write(f"Empate: {draw*100:.1f}%\n")
    f.write(f"{away} gana: {away_win*100:.1f}%\n\n")
    f.write("Ambos anotan:\n")
    f.write(f"Sí: {btts_yes*100:.1f}%\n")
    f.write(f"No: {btts_no*100:.1f}%\n\n")
    f.write("Más/Menos 2.5 goles:\n")
    f.write(f"Over 2.5: {over25*100:.1f}%\n")
    f.write(f"Under 2.5: {under25*100:.1f}%\n\n")
    f.write("Doble oportunidad:\n")
    f.write(f"1X: {one_x*100:.1f}%\n")
    f.write(f"X2: {x_two*100:.1f}%\n")
    f.write(f"12: {one_two*100:.1f}%\n")